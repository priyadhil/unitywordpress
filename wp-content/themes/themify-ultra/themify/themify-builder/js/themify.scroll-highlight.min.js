...
b]:a["page"+b]}var c=this,h=[];this.options=b.extend({},c.defaults,a);if(!Themify.is_builder_active&&(b("div[class*="+c.options.prefix.replace(".","")+"]:visible").not(c.options.exclude).each(function(){h.push(b(this))}),!h.length))return;c.setHeaderHeight();var m,n;b(this.options.context).on("touchstart",'a[href*="#"], area[href*="#"]',function(a){a.stopPropagation();m=g(a,"X");n=g(a,"Y")}).on("click touchend",'a[href*="#"], area[href*="#"]',function(a){if((!/touch/.test(a.type)||20>Math.abs(g(a,
"X")-m)&&20>Math.abs(g(a,"Y")-n))&&this.host===d.location.host&&this.pathname===d.location.pathname&&!1===f&&!this.classList.contains("ab-item")){var e=c.cleanHash(b(this));if("#"!==e){var e=-1!=e.indexOf("/")?e.substring(0,e.indexOf("/")):e,h=e.replace(/#/,c.options.prefix);0<b(h).length&&(a.preventDefault(),a.stopPropagation(),f=!0,c.linkScroll(h,e),Themify.is_builder_active&&(l=!0,c.changeHash("#"+b(h).data("anchor"))))}}});Themify.is_builder_active||(e.on("scroll",function(){c.scrolling=!0}),
this.requestInterval(function(){!k&&c.scrolling&&c.manualScroll(h)},c.options.scrollRate),e.on("load hashchange",function(a){if(!1===f)if(f=!0,c.isHash(d.location.hash)){var e=c.cleanHash(d.location.hash),g=!1;a=c.cleanupURL(d.location.href);a=b(c.options.context).find('a[href="'+e+'"], a[href="'+a+e+'"], a[href="'+a+"/"+e+'"]');if(a.length)a.each(function(){var a=b(this);c.cleanHash(a)===e&&(g=!0,setTimeout(function(){f=!1;a.trigger("click.themifyScroll")},600))}),!1===g&&(f=!1);else{var k=e.replace(/#/,
c.options.prefix);-1===k.search("/")&&b(k).length?setTimeout(function(){c.linkScroll(k,e)},600):f=!1}}else f=!1,c.manualScroll(h)}));b(d).load(function(){setTimeout(function(){c.setHeaderHeight()},1E4)})}}}(jQuery,window,document);
