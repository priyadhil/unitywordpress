...
else{var a=this;u.Themify.body.one("themify_builder_ready",function(b){a.openStylingPanel();a=null})}else null!==themifyBuilder.globalStyles&&(this.extend(this.styles,themifyBuilder.globalStyles),themifyBuilder.globalStyles=null)},extend:function(a,b){for(var c in b)b[c]!==t&&(a[c]=b[c]);return a},openStylingPanel:function(){var a=function(){var d=themifyBuilder.globalStyleData.type,d=b.Models.Registry.lookup(b.Instances.Builder[b.builderIndex].el.getElementsByClassName(("row"===d||"column"===d||
...
c,e="";null!==(c=b.exec(a));)e+=" "+c[1].trim();e=e.trim();if(""!==e){e=h.unique(e.split(" "));a=[];for(b=e.length-1;-1<b;--b)this.styles[e[b]]!==t&&a.push(e[b]);return a}return!1},globalStylesHTML:function(){if(!0===this.isGSPage||null!==this.activeGS)return!1;var a=r.createElement("div"),d=r.createElement("div"),c=r.createElement("span");this.isShown=null;this.field=ThemifyConstructor.hidden.render({id:b.GS.key,is_responsive:!1,value:ThemifyConstructor.values[b.GS.key],control:!1},ThemifyConstructor);
a.className="tb_gs_container";if(this.field.value){for(var e=this.field.value.split(" "),f="",g=e.length-1;-1<g;--g)this.styles[e[g]]!==t&&(f+=" "+e[g]);f=f.trim();this.field.value=f}else this.field.value="";d.className="tb_gs_icon ti-brush-alt";d.addEventListener("click",function(a){if(a.target.classList.contains("tb_gs_icon")){var c=this.el;if(c.classList.contains("tb_gs_dropdown_opened"))a.stopPropagation(),c.classList.remove("tb_gs_dropdown_action"),c.classList.remove("tb_gs_dropdown_opened");
